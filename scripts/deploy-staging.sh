...
kubectl -n "$K8S_NAMESPACE" rollout status deployment/emissions-backend --timeout=180s
kubectl -n "$K8S_NAMESPACE" rollout status deployment/emissions-frontend --timeout=180s
